package org.ares.app.wxtck.common.util.qrc;
...
public class QrcUtil {
    ...
    public  BufferedImage getBufferedImage (String content,Integer size,String logoPath) {
        ...
        try {
            ...
            Map<EncodeHintType, Object> hints = new HashMap<EncodeHintType, Object>();// 设置编码字符集
            hints.put(EncodeHintType.CHARACTER_SET, "UTF-8");//设置编码
            hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.H); //设置容错率最高 
    ...
    static final int BLACK = 0xFF000000;// 二维码颜色==黑色
    static final int WHITE = 0xFFFFFFFF; // 二维码颜色==白色
    static final List<String> IMAGE_TYPE = Arrays.asList(new String[] {"jpg","png"});// 二维码图片格式==jpg和png两种
